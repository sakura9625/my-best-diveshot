...
class ExtraMySelectSettingsScreen extends ConsumerWidget {
  final int slotIndex;

  const ExtraMySelectSettingsScreen({super.key, required this.slotIndex});
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: ListTile(
              ...
              onTap: () => _showEditDialog(context, ref, index, theme.name),
            ),
          );
        },
      ),
          ...
          TextButton(
            onPressed: () {
              ...
              if (newName.isNotEmpty) {
                ref.read(extraMySelectThemesProvider(slotIndex).notifier).updateTheme(index, newName);
              }
